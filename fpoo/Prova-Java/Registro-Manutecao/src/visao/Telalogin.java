...
//			int indice = ManutencaoProcessa.checarEmail(email.getText());
//			if (indice != -1) {
//				if (ManutencaoProcessa.checarSenha(indice, Cripto.encripta(new String(senha.getPassword())))) {
//					this.dispose();// Fecha o Formul�rio
//					ManutencaoCRUD uc = new ManutencaoCRUD();
//					uc.setVisible(true);
//				} else {
