...
-- Criando uma Procedure que Registre um pedido de 3 Itens Utilizando Transações
...
create procedure insere_dados()
	...
	start transaction;
		insert into pedidos values (27, 12, curdate(), curtime(), null);
		insert into Itens_Pedido(pedido_id, pizza_id, quantidade, valor) values(27,6,1, (select valor from Pizzas where pizza_id = 6));
		insert into Itens_Pedido(pedido_id, pizza_id, quantidade, valor) values(27,9,1, (select valor from Pizzas where pizza_id = 9));
		insert into Itens_Pedido(pedido_id, pizza_id, quantidade, valor) values(27,3,1, (select valor from Pizzas where pizza_id = 3));
