...
LOAD DATA INFILE 'D:/Github/luiz/SENAI/2DES/bd/aula05/csv/onibus/motoristas.csv'
...
LOAD DATA INFILE 'D:/Github/luiz/SENAI/2DES/bd/aula05/csv/telefones.csv'
...
LOAD DATA INFILE 'D:/Github/luiz/SENAI/2DES/bd/aula05/csv/linhas.csv'
INTO TABLE linhas
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
...
LOAD DATA INFILE 'D:/Github/luiz/SENAI/2DES/bd/aula05/csv/horarios.csv'
INTO TABLE horarios
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
...
LOAD DATA INFILE 'D:/Github/luiz/SENAI/2DES/bd/aula05/csv/mot_linhas.csv'
