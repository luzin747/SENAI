...
LOAD DATA INFILE 'D:/Github/luiz/SENAI/2DES/backend/Exercicios/Ex-03/academia/docs/csv/alunos.csv'
INTO TABLE alunos
...
LOAD DATA INFILE 'D:/Github/luiz/SENAI/2DES/backend/Exercicios/Ex-03/academia/docs/csv/telefones.csv'
...
LOAD DATA INFILE 'D:/Github/luiz/SENAI/2DES/backend/Exercicios/Ex-03/academia/docs/csv/aparelhos.csv'
...
LOAD DATA INFILE 'D:/Github/luiz/SENAI/2DES/backend/Exercicios/Ex-03/academia/docs/csv/exercicios.csv'
...
LOAD DATA INFILE 'D:/Github/luiz/SENAI/2DES/backend/Exercicios/Ex-03/academia/docs/csv/fichas.csv'
INTO TABLE fichas
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
