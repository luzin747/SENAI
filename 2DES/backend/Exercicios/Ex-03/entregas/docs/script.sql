...
LOAD DATA INFILE 'D:/Github/luiz/SENAI/2DES/backend/Exercicios/Ex-03/entregas/docs/csv/clientes.csv'
INTO TABLE clientes
...
LOAD DATA INFILE 'D:/Github/luiz/SENAI/2DES/backend/Exercicios/Ex-03/entregas/docs/csv/telefones.csv'
...
LOAD DATA INFILE 'D:/Github/luiz/SENAI/2DES/backend/Exercicios/Ex-03/entregas/docs/csv/entregadores.csv'
...
LOAD DATA INFILE 'D:/Github/luiz/SENAI/2DES/backend/Exercicios/Ex-03/entregas/docs/csv/produtos.csv'
INTO TABLE produtos
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
...
LOAD DATA INFILE 'D:/Github/luiz/SENAI/2DES/backend/Exercicios/Ex-03/entregas/docs/csv/pedidos.csv'
INTO TABLE pedidos
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
...
LOAD DATA INFILE 'D:/Github/luiz/SENAI/2DES/backend/Exercicios/Ex-03/entregas/docs/csv/itens.csv'
INTO TABLE itens
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
