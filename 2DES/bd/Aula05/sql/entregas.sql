...
LOAD DATA INFILE 'D:/Github/luiz/SENAI/2DES/bd/aula05/csv/entregas/clientes.csv'
INTO TABLE clientes
...
LOAD DATA INFILE 'D:/Github/luiz/SENAI/2DES/bd/aula05/csv/entregas/telefones.csv'
...
LOAD DATA INFILE 'D:/Github/luiz/SENAI/2DES/bd/aula05/csv/entregas/produtos.csv'
INTO TABLE produtos
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
...
LOAD DATA INFILE 'D:/Github/luiz/SENAI/2DES/bd/aula05/csv/entregas/itens.csv'
INTO TABLE itens
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
